...
--
-- Name: alembic_version; Type: TABLE; Schema: public; Owner: realestate
--
...
ALTER TABLE public.alembic_version OWNER TO realestate;
...
--
-- Name: alembic_version alembic_version_pkc; Type: CONSTRAINT; Schema: public; Owner: realestate
--
