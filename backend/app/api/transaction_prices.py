...
# 区とエリアのマッピング定義（モジュールレベルの定数）
DISTRICT_MAPPING = {
    "千代田区": ["一番町", "二番町", "三番町", "四番町", "五番町", "六番町", "九段北", "九段南", "内神田", "内幸町",
              "北の丸公園", "外神田", "大手町", "岩本町", "平河町", "日比谷公園", "有楽町", "東神田",
              "永田町", "神田三崎町", "神田神保町", "神田佐久間町", "神田司町", "神田和泉町", "神田多町", "神田小川町",
              "神田岩本町", "神田富山町", "神田東松下町", "神田東紺屋町", "神田淡路町", "神田相生町", "神田紺屋町",
              "神田猿楽町", "神田練塀町", "神田美倉町", "神田美土代町", "神田花岡町", "神田西福田町", "神田錦町", "神田須田町",
              "神田駿河台", "神田鍛冶町", "紀尾井町", "西神田", "隼町", "霞が関", "飯田橋", "鍛冶町",
              "麹町", "丸の内"],
    "中央区": ["京橋", "佃", "入船", "八丁堀", "勝どき", "新富", "新川", "日本橋", "日本橋中洲",
              "日本橋久松町", "日本橋人形町", "日本橋兜町", "日本橋堀留町", "日本橋大伝馬町", "日本橋富沢町", "日本橋室町", "日本橋小伝馬町",
              "日本橋小網町", "日本橋小舟町", "日本橋横山町", "日本橋本町", "日本橋本石町", "日本橋東", "日本橋浜町",
              "日本橋箱崎町", "日本橋蛎殻町", "日本橋茅場町", "日本橋馬喰町", "明石町", "月島", "東日本橋",
              "晴海", "浜離宮庭園", "湊", "築地", "築地町", "銀座", "豊海町"],
    "港区": ["三田", "元赤坂", "元麻布", "六本木", "北青山", "南青山", "南麻布", "台場", "東新橋",
             "東麻布", "愛宕", "海岸", "港南", "浜松町", "白金", "白金台", "芝", "芝公園", "芝大門", "芝浦",
             "虎ノ門", "西新橋", "西麻布", "赤坂", "高輪", "麻布十番", "麻布台", "麻布永坂町",
             "麻布狸穴町", "新橋"],
    "新宿区": ["上落合", "下宮比町", "下落合", "中井", "中町", "中落合", "中里町", "二十騎町", "余丁町",
              "住吉町", "信濃町", "内藤町", "北山伏町", "北新宿", "北町", "南元町", "南山伏町", "南榎町",
              "南町", "原町", "喜久井町", "四谷", "四谷三栄町", "四谷坂町", "四谷本塩町", "坂町", "大京町", "大久保", "天神町",
              "富久町", "富士見", "左門町", "市谷", "市谷仲之町", "市谷八幡町", "市谷加賀町", "市谷台町", "市谷山伏町",
              "市谷左内町", "市谷本村町", "市谷柳町", "市谷田町", "市谷甲良町", "市谷砂土原町",
              "市谷船河原町", "市谷薬王寺町", "市谷長延寺町", "市谷鷹匠町", "岩戸町", "弁天町", "戸塚町", "戸山",
              "払方町", "揚場町", "改代町", "新宿", "新小川町", "早稲田", "早稲田南町", "早稲田町", "早稲田鶴巻町",
              "東五軒町", "東榎町", "歌舞伎町", "河田町", "津久戸町", "片町", "牛込中央通り", "神楽坂",
              "神楽河岸", "白銀町", "百人町", "矢来町", "箪笥町", "納戸町", "細工町", "若宮町", "若松町",
              "若葉", "榎町", "横寺町", "荒木町", "舟町", "西五軒町", "西早稲田", "西新宿", "西落合", "赤城下町", "赤城元町",
              "袋町", "須賀町", "筑土八幡町", "馬場下町", "霞ケ丘町", "高田馬場", "鶴巻町"],
    "文京区": ["千石", "千駄木", "向丘", "大塚", "小日向", "小石川", "山吹町", "弥生", "後楽", "春日", "本郷",
              "本駒込", "根津", "水道", "水道町", "湯島", "白山", "目白台", "西片", "関口", "音羽"],
    ...
    "世田谷区": ["三宿", "三軒茶屋", "上北沢", "上用賀", "上祖師谷", "上野毛", "上馬", "下馬", "世田谷",
                ...
                "等々力", "粟谷", "経堂", "給田", "船橋", "若林", "豪徳寺", "赤堤", "野毛", "野沢",
                "鎌田", "駒沢", "駒沢公園"],
    "渋谷区": ["上原", "代々木", "代官山町", "元代々木町", "初台", "円山町", "千駄ケ谷", "南平台町",
              "宇田川町", "恵比寿", "恵比寿南", "恵比寿西", "幡ケ谷", "広尾", "愛住町", "本町", "東", "松濤", "桜丘町",
              "猿楽町", "渋谷", "神南", "神宮前", "神山町", "神泉町", "笹塚", "西原", "道玄坂", "鉢山町",
              "鶯谷町", "富ケ谷", "富ヶ谷"],
    ...
    "北区": ["上中里", "上十条", "中十条", "中里", "十条仲原", "十条台", "堀船", "岩淵町", "岸町",
            ...
            "赤羽南", "赤羽台", "赤羽西"],
    "荒川区": ["おぶ茶屋", "亀有", "四つ木", "堀切", "奥戸", "宝町", "小菅", "新宿", "新小岩",
    ...
    "練馬区": ["三原台", "上石神井", "上石神井南町", "下石神井", "中村", "中村北", "中村南", "光が丘",
              ...
              "平和台", "春日町", "旭丘", "旭町", "東大泉", "栄町", "桜台", "氷川台", "田柄",
    ...
    "葛飾区": ["おお茶屋", "亀有", "四つ木", "堀切", "奥戸", "宝町", "小菅", "新宿", "新小岩",
              "東四つ木", "東堀切", "東新小岩", "東水元", "東立石", "東金町", "柴又", "水元", "水元公園",
              "白鳥", "立石", "細田", "西亀有", "西新小岩", "西水元", "金町", "金町浄水場", "青戸", "鎌倉",
              "高砂"],
...
async def get_transactions(
    ...
    if district:
        # get_areas_by_districtからdistrict_mappingを取得（完全なマッピングを使用）
        from . import transaction_prices as tp_module
        # 区とエリアのマッピング定義（get_areas_by_districtと同じものを使用）
        # ここでは簡略化のため、APIを呼び出さずに直接マッピングを使用
        district_areas_query = db.query(TransactionPrice.area_name).distinct().all()
        all_areas_in_db = {area[0] for area in district_areas_query if area[0]}
        
        # district_mappingの完全版を使用（get_areas_by_districtと同じ）
        # ※ここでは実際のエリアでフィルタリングするため、データベースから取得したエリア名を使用
        # 区からエリアを逆引きする代わりに、エリア名に区名が含まれているかチェック
        # より正確には、get_areas_by_districtと同じロジックを適用
        
        # 簡略化: エリア名から区を判定（より正確な実装が必要）
        # ここでは一旦、全エリアから区に該当するものをフィルタ
        query = query.filter(TransactionPrice.area_name.in_(all_areas_in_db))
