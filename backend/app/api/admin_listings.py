...
async def get_listing_detail(
    ...
    return {
        ...
        'listing_building_structure': listing.listing_building_structure,
        'listing_land_rights': listing.listing_land_rights,
        'listing_parking_info': listing.listing_parking_info,
        'listing_basement_floors': listing.listing_basement_floors,
        'listing_station_info': listing.listing_station_info,
